...
import { Colors } from '../../theme'; // Importing colors
      ...
      <Portal>
        ...
        >
          <ScrollView>
            <Text
              variant="titleLarge"
              style={[styles.modalTitle, { color: Colors.text }]} // Updated text color
            >
            ...
            <Calendar
              ...
              markedDates={{
                [selectedDate]: {
                  selected: true,
                  selectedColor: Colors.primary, // Calendar selection color
                },
              }}
            ...
            {showStartTime && (
              <DateTimePicker
                value={
                  shiftForm.startTime
                    ? new Date(`2000-01-01T${shiftForm.startTime}`)
                    : new Date()
                }
                mode="time"
                is24Hour={true}
            ...
            {showEndTime && (
              <DateTimePicker
                value={
                  shiftForm.endTime
                    ? new Date(`2000-01-01T${shiftForm.endTime}`)
                    : new Date()
                }
                mode="time"
                is24Hour={true}
...
const styles = StyleSheet.create({
  ...
  modalContainer: {
    backgroundColor: Colors.background, // Updated modal background color
    padding: 20,
    margin: 20,
    maxHeight: '80%',
    borderRadius: 8,
